...
<div class="container-fluid page-header-content">
    <div class="container">
        ...
        <!-- Content -->
        <div class="row mt-4">
            <div class="col-12 edi-policy-content">
                ...
                <h5 class="edi-policy-heading">1. The Trail Guide (Eligibility & Adult Oversight)</h5>
                <ul>
                ...
                <h5 class="edi-policy-heading">2. Guarding the Treasure (Intellectual Property Rights)</h5>
                <ul>
                ...
                <h5 class="edi-policy-heading">3. Trading at The Honey Market (Product Details & Pricing)</h5>
                <ul>
                ...
                <h5 class="edi-policy-heading">4. Supply Drop Logistics (Payment, Shipping & Order Rules)</h5>
                <ul>
                ...
                <h5 class="edi-policy-heading">5. Trail Adjustments (Cancellations & Exchanges)</h5>
                <ul>
                ...
                <h5 class="edi-policy-heading">6. Code of the Jungle (Community Guidelines for "My Family")</h5>
                ...
                <h5 class="edi-policy-heading">7. Disclaimer of Adventure (Limitation of Liability)</h5>
                ...
                <h5 class="edi-policy-heading">8. Governing Law</h5>
                ...
                <h5 class="edi-policy-heading">9. Need to Reach the Base Camp?</h5>
