                    ...
                    <div class="row pb-3">
                        <?php
                            if ( $homeworkPageNo > 1 ) {
                                ...
                                $other = "id<" . $user->fetchAll(array("id"), array("homework_details"), $conditions, "id DESC LIMIT $limit", $listComboOtherH)[$limit-1]['id'];
                            } else {
                                $other = "";
                            }
                            if ( $other!="" ) {
                                $other = "$other AND $listComboOtherH";
                            } else {
                                $other = $listComboOtherH;
                            }
